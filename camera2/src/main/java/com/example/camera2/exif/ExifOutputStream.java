...
class ExifOutputStream extends FilterOutputStream {
  ...
  private void createRequiredIfdAndTag() throws IOException {
    ...
    if (interIfd != null) {
      ...
      if (interOffsetTag == null) {
        throw new IOException(
            "No definition for crucial exif tag: " + ExifInterface.TAG_INTEROPERABILITY_IFD);
      }
    ...
    if (mExifData.hasCompressedThumbnail()) {
      ...
      if (offsetTag == null) {
        throw new IOException(
            "No definition for crucial exif tag: " + ExifInterface.TAG_JPEG_INTERCHANGE_FORMAT);
      }
      ...
      if (lengthTag == null) {
        throw new IOException(
            "No definition for crucial exif tag: " + ExifInterface.TAG_STRIP_BYTE_COUNTS);
      }
  ...
  private int calculateAllOffset() {
    ...
    if (interIfd != null) {
      exifIfd
          .getTag(ExifInterface.getTrueTagKey(ExifInterface.TAG_INTEROPERABILITY_IFD))
          .setValue(offset);
