...
public class JsoupActivity extends AppCompatActivity {
        ...
        .request(
            new OnPermission() {
              ...
              public void noPermission(List<String> denied, boolean quick) {
                Toast.makeText(JsoupActivity.this, "请务必授权", Toast.LENGTH_LONG).show();
  ...
  public void update(View view) {
    File f = new File(FetchImgsUtil.getRootDir(JsoupActivity.this) + "/chenhan");
    Intent intent = new Intent(Intent.ACTION_MEDIA_SCANNER_SCAN_FILE);
    Uri uri = Uri.fromFile(f);
    intent.setData(uri);
    JsoupActivity.this.sendBroadcast(intent);
  }
  ...
  private Handler handler =
      new Handler(Looper.getMainLooper()) {
        ...
        public void handleMessage(@NonNull Message msg) {
          ...
          count.setText("爬虫次数：" + countNumber + "次");
                  ...
                  try {
                    ...
                    for (int i = 0; i < imgs.size(); i++) {
                          ...
                          new Runnable() {
                            ...
                            public void run() {
                              if (finalI == imgs.size() - 1) {
                                ...
                                File f =
                                    new File(
                                        FetchImgsUtil.getRootDir(JsoupActivity.this) + "/chenhan");
                                Intent intent = new Intent(Intent.ACTION_MEDIA_SCANNER_SCAN_FILE);
                                Uri uri = Uri.fromFile(f);
                                intent.setData(uri);
                                JsoupActivity.this.sendBroadcast(intent);
                      ...
                      FetchImgsUtil.downImages(
                          FetchImgsUtil.getRootDir(JsoupActivity.this) + "/chenhan", imgSrc);
                      Log.e("chenhan", "下载完成");
                    }
