...
public class Banner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private int mIndicatorSelectedResId = R.drawable.point_gray;
    private int mIndicatorUnselectedResId = R.drawable.point_white;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorSelectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_selected, R.drawable.point_gray);
        mIndicatorUnselectedResId = typedArray.getResourceId(R.styleable.Banner_indicator_drawable_unselected, R.drawable.point_white);
    ...
    /**支持扩展自定义动画，需实现PageTransformer，onTransform中操作view实现具体动画效果*/
